package com.gome.manager.ericsoft.demo;

import java.util.Date;

import com.gome.manager.ericsoft.bmob.bson.BSON;
import com.gome.manager.ericsoft.bmob.bson.BSONObject;
import com.gome.manager.ericsoft.bmob.restapi.Bmob;
...
public class TestDemo {
	...
	private static void initBmob(){
		Bmob.initBmob("6ba0004840873d3d3b5eed6946240d1e",
		"1435dd28ab5e727441158cfed3f3bd51");		
			
		//用到超级权限需要注册该Key
		Bmob.initMaster("5ea2489fee0f748c3b98b81d8179ddaa");
	}
	...
	private static void requestSms(){
		String res=Bmob.requestSms("13699167012","您的验证码是：222222, 有效期是10分钟。");
		System.out.println(res);		
	}
