...
public class SendMail {
	...
	// 设置发件人的邮箱信息，邮件服务器地址
	private static String mailAddress = "liuhk1989@163.com";
	private static String mailCount = "liuhk1989@163.com"; // @前的邮件地址和用户名要一致
	private static String mailPassword = "teamo1989";
	...
	public static void main(String[] args) {
		...
		String[] str_to = {"353781143@qq.com"};
